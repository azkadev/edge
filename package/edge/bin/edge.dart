...
void main(List<String> args_raw) async {
  Future<Directory?> getPackageDirectory({
    String package_name = "package:edge/edge.dart",
  }) async {
  ...
  Directory? base_directory_lib =
      (await getPackageDirectory(package_name: "package:edge/edge.dart"));
...
Global options:
  ...
  reload               Reload package edge.dart
...
""";
  ...
  if (command == "version") {
    print("edge version: 0.0.0 (stable) on ${Platform.operatingSystem}");
    exit(0);
  }
