...
p=o}else p=o
J.St(p,q)}return n},
Lt(a,a0,a1,a2,a3){var s=0,r=A.F(t.W),q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b
var $async$Lt=A.l(function(a4,a5){if(a4===1)return A.f(a5,r)
while(true)switch(s){case 0:A.FL("etes")
p=A.ht(a)
o=a1.a
n=a3.a
m=a0==null?self.undefined:a0
if(m==null)m=self.undefined
l=self.undefined
if(l==null)l=self.undefined
k=self.undefined
if(k==null)k=self.undefined
if(o==null)o=self.undefined
j=self.undefined
i=self.undefined
h=self.undefined
...
f=self.undefined
e=self.undefined
if(e==null)e=self.undefined
d=self.undefined
c=t.e
d=c.a({body:m,cache:l,credentials:k,headers:o,integrity:j,keepalive:i,method:a2,mode:h,redirect:g,referrer:f,referrerPolicy:e,signal:n,window:d})
n=self.self
b=A
s=3
return A.j(A.ft(A.ft(n.fetch.apply(n,[p,d]),c),c),$async$Lt)
case 3:q=new b.AV(a5)
s=1
break
case 1:return A.y(q,r)}})
...
A.FL(m)
s=J.cf(m,"/telegram_bot/invoice")?7:8
break
case 7:s=9
